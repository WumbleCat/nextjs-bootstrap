...
<div style={{ position: 'relative', height: '475px', opacity: 0.85 }}>
      ...
      <div className="position-absolute top-50 start-50 translate-middle rounded p-3 border border-2" style={{ backgroundColor: '#00008B' }}>
        ...
        <p className='text-white text-center mb-0'>Welcome to the UoB Data Science Reps website! This is an unofficial website created by students from studying the Data Science course, serving as an information hub for Final Year DS students in 2023/24 Cohort.</p>
      </div>
    </div>
